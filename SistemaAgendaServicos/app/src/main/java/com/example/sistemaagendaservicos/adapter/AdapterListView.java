package com.example.sistemaagendaservicos.adapter;
...
public class AdapterListView extends BaseAdapter {
    ...
    public View getView(final int posicao, View ConvertView, ViewGroup parent) {
        ...
        TextView textView = (TextView)  view.findViewById(R.id.textView_ListView);
        CardView cardView = (CardView) view.findViewById(R.id.cardView_ListView);
